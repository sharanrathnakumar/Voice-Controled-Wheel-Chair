...
const char* password = "sharanrk12";
...
void setup()
{
  ...
  analogWrite(eneLeftMotor,10);
  analogWrite(eneRightMotor,10);
...
void loop()
{
 ...
 // else if (command == "faster") faster();
 // else if (command == "slower") slower();
...
void faster(void)
{
    ...
    analogWrite(eneLeftMotor,110);
    analogWrite(eneRightMotor,110);
}
